    ...
    <div className="flex flex-col h-full bg-white dark:bg-slate-950">
      ...
      <div className="flex-1 pt-6 px-8 pb-32 overflow-y-auto no-scrollbar -mt-6 bg-white dark:bg-slate-950 rounded-t-3xl relative z-10">
        ...
        <div className="mt-8 p-4 bg-navy rounded-xl shadow-lg text-white flex items-center justify-between">
          ...
          <button 
            onClick={() => alert('Wine pairing list coming soon!')}
            className="bg-white text-navy text-xs font-bold px-3 py-2 rounded-lg active:scale-95 transition-transform"
          >
            View List
          </button>
        </div>
      ...
      <div className="absolute bottom-0 left-0 right-0 p-5 bg-white dark:bg-slate-950 border-t border-slate-100 dark:border-slate-800 z-50 pb-8">
        <div className="flex items-center gap-4">
          ...
          <button 
            onClick={() => alert('Server has been notified! They will be with you shortly.')}
            className="flex-[2] bg-navy text-white font-bold py-3 px-6 rounded-xl shadow-lg flex items-center justify-center gap-2 active:scale-[0.98] transition-all"
          >
