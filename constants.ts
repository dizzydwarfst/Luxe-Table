...
export const MENU_ITEMS: MenuItem[] = [
  ...
  },
  {
    ...
    availableToppings: [
      { id: 'top-1',        name: 'Capicolla',    price: 2.50, modelUrl: '/Capicolla.glb',                binaryBit: 1,   emoji: '🥩', color: '#e85d3a' },
      { id: 'mushroom',     name: 'Mushroom',     price: 0.75, modelUrl: '/models/toppings/mushroom.glb', binaryBit: 2,   emoji: '🍄', color: '#8B5E3C' },
      { id: 'pepper',       name: 'Pepper',       price: 0.75, modelUrl: '/models/toppings/pepper.glb',   binaryBit: 4,   emoji: '🌶️', color: '#ef4444' },
      { id: 'olive',        name: 'Olive',        price: 0.60, modelUrl: '/models/toppings/olive.glb',    binaryBit: 8,   emoji: '🫒', color: '#4a4a6a' },
      { id: 'basil',        name: 'Basil',        price: 0.50, modelUrl: '/models/toppings/basil.glb',    binaryBit: 16,  emoji: '🌿', color: '#2d8a4e' },
      { id: 'extra-cheese', name: 'Extra Cheese', price: 1.00, modelUrl: '/models/toppings/cheese.glb',   binaryBit: 32,  emoji: '🧀', color: '#f5c518' },
      { id: 'onion',        name: 'Red Onion',    price: 0.60, modelUrl: '/models/toppings/onion.glb',    binaryBit: 64,  emoji: '🧅', color: '#c084fc' },
      { id: 'tomato',       name: 'Sun Tomato',   price: 0.70, modelUrl: '/models/toppings/tomato.glb',   binaryBit: 128, emoji: '🍅', color: '#f97316' },
      { id: 'bacon',        name: 'Crispy Bacon', price: 1.25, modelUrl: '/models/toppings/bacon.glb',    binaryBit: 256, emoji: '🥓', color: '#b45309' },
    ]
  },
...
// ─── Toppings (standalone — for use outside of pizza item context) ─────────────
